...
export const Faq = () => {
  return (
    <div className="mt-10 w-full rounded-3xl bg-[#f6f5f4] md:py-10">
      <div className="p-10 md:p-4 md:px-20">
        <div className="text-3xl font-bold text-black md:text-7xl">Have questions?</div>

        <div className="mt-4 bg-gradient-to-r from-emerald-600 to-blue-300 bg-clip-text text-3xl font-semibold text-transparent md:text-6xl">
          Get answers.
        </div>
